...
age_date = today - date_birth
age_year = age_date.days // 365
age_month = age_date.days % 365 // 30
age_day = age_date.days % 365 % 30 
print(f'Today : {today}\n')
print(f'You {age_year} years old, and {age_month} month and {age_day} day')
